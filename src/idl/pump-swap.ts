    ...
    "instructions": [
        {
            ...
            "accounts": [
                ...
                { "name": "globalConfig" },
                { "name": "baseMint", "relations": ["pool"] },
                { "name": "quoteMint", "relations": ["pool"] },
                { "name": "userBaseTokenAccount", "writable": true },
                { "name": "userQuoteTokenAccount", "writable": true },
                { "name": "poolBaseTokenAccount", "writable": true, "relations": ["pool"] },
                { "name": "poolQuoteTokenAccount", "writable": true, "relations": ["pool"] },
                { "name": "protocolFeeRecipient" },
                {
                    ...
                    "pda": {
                        "seeds": [
                            { "kind": "account", "path": "protocolFeeRecipient" },
                            { "kind": "account", "path": "quoteTokenProgram" },
            ...
            "args": [
                ...
                { "name": "maxQuoteAmountIn", "type": "u64" }
            ]
        },
        {
            "name": "createConfig",
            ...
            "accounts": [
                { "name": "admin", "writable": true, "signer": true, "address": "px7JjkgjgQXMMHi2ff9QB68zmp4TDxwzeuTqpC48Pmm" },
                {
                    "name": "globalConfig",
                    "writable": true,
                    "pda": {
            ...
            "args": [
                ...
                { "name": "protocolFeeRecipients", "type": { "array": ["pubkey", 8] } }
            ]
        },
        {
            "name": "createPool",
            ...
            "accounts": [
                ...
                { "name": "userQuoteTokenAccount", "writable": true },
                {
                    ...
                    "pda": {
                        "seeds": [
                            { "kind": "account", "path": "creator" },
                            { "kind": "account", "path": "token2022Program" },
                            { "kind": "account", "path": "lpMint" }
                        ],
                        "program": {
                            "kind": "const",
                            "value": [140, 151, 37, 143, 78, 36, 137, 241, 187, 61, 16, 41, 20, 142, 13, 131, 11, 90, 19, 153, 218, 255, 16, 132, 4, 142, 123, 216, 219, 233, 248, 89]
                ...
                },
                {
                    ...
                    "pda": {
                        "seeds": [
                            { "kind": "account", "path": "pool" },
                            { "kind": "account", "path": "baseTokenProgram" },
                            { "kind": "account", "path": "baseMint" }
                        ],
                        "program": {
                            "kind": "const",
        ...
        },
        {
            ...
            "accounts": [
                ...
                { "name": "baseMint", "relations": ["pool"] },
                { "name": "quoteMint", "relations": ["pool"] },
                { "name": "lpMint", "writable": true, "relations": ["pool"] },
                { "name": "userBaseTokenAccount", "writable": true },
                { "name": "userQuoteTokenAccount", "writable": true },
                { "name": "userPoolTokenAccount", "writable": true },
                { "name": "poolBaseTokenAccount", "writable": true, "relations": ["pool"] },
                { "name": "poolQuoteTokenAccount", "writable": true, "relations": ["pool"] },
        ...
        },
        {
            ...
            "accounts": [
                { "name": "admin", "signer": true, "relations": ["globalConfig"] },
            ...
            "args": [
                { "name": "disableCreatePool", "type": "bool" },
                { "name": "disableDeposit", "type": "bool" },
                { "name": "disableWithdraw", "type": "bool" },
                { "name": "disableBuy", "type": "bool" },
                { "name": "disableSell", "type": "bool" }
            ]
        },
        {
            "name": "extendAccount",
        ...
        },
        {
            ...
            "args": [
                { "name": "baseAmountIn", "type": "u64" },
                { "name": "minQuoteAmountOut", "type": "u64" }
            ]
        },
        {
            "name": "updateAdmin",
        ...
        },
        {
            ...
            "args": [
                { "name": "lpTokenAmountIn", "type": "u64" },
                { "name": "minBaseAmountOut", "type": "u64" },
                { "name": "minQuoteAmountOut", "type": "u64" }
            ]
        }
    ],
    ...
    "types": [
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    { "name": "baseAmountOut", "type": "u64" },
                    { "name": "maxQuoteAmountIn", "type": "u64" },
                    { "name": "userBaseTokenReserves", "type": "u64" },
                    { "name": "userQuoteTokenReserves", "type": "u64" },
                    { "name": "poolBaseTokenReserves", "type": "u64" },
                    { "name": "poolQuoteTokenReserves", "type": "u64" },
                    { "name": "quoteAmountIn", "type": "u64" },
                    { "name": "lpFeeBasisPoints", "type": "u64" },
                    { "name": "lpFee", "type": "u64" },
                    { "name": "protocolFeeBasisPoints", "type": "u64" },
                    { "name": "protocolFee", "type": "u64" },
                    { "name": "quoteAmountInWithLpFee", "type": "u64" },
                    { "name": "userQuoteAmountIn", "type": "u64" },
                    { "name": "pool", "type": "pubkey" },
                    { "name": "user", "type": "pubkey" },
                    { "name": "userBaseTokenAccount", "type": "pubkey" },
                    { "name": "userQuoteTokenAccount", "type": "pubkey" },
                    { "name": "protocolFeeRecipient", "type": "pubkey" },
                    { "name": "protocolFeeRecipientTokenAccount", "type": "pubkey" }
                ]
            }
        },
        {
        ...
        },
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    { "name": "baseAmountIn", "type": "u64" },
                    { "name": "quoteAmountIn", "type": "u64" },
                    { "name": "lpMintSupply", "type": "u64" },
                    { "name": "pool", "type": "pubkey" },
                    { "name": "user", "type": "pubkey" },
                    { "name": "userBaseTokenAccount", "type": "pubkey" },
                    { "name": "userQuoteTokenAccount", "type": "pubkey" },
                    { "name": "userPoolTokenAccount", "type": "pubkey" }
                ]
            }
        },
        {
        ...
        },
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    { "name": "user", "type": "pubkey" },
                    { "name": "currentSize", "type": "u64" },
                    { "name": "newSize", "type": "u64" }
                ]
            }
        },
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    { "name": "lpFeeBasisPoints", "docs": ["The lp fee in basis points (0.01%)"], "type": "u64" },
                    { "name": "protocolFeeBasisPoints", "docs": ["The protocol fee in basis points (0.01%)"], "type": "u64" },
                    { "name": "disableFlags", "docs": ["Flags to disable certain functionality", "bit 0 - Disable create pool", "bit 1 - Disable deposit", "bit 2 - Disable withdraw", "bit 3 - Disable buy", "bit 4 - Disable sell"], "type": "u8" },
                    { "name": "protocolFeeRecipients", "docs": ["Addresses of the protocol fee recipients"], "type": { "array": ["pubkey", 8] } }
                ]
            }
        },
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    { "name": "lpSupply", "docs": ["True circulating supply without burns and lock-ups"], "type": "u64" }
                ]
            }
        },
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    { "name": "poolBaseTokenReserves", "type": "u64" },
                    { "name": "poolQuoteTokenReserves", "type": "u64" },
                    { "name": "quoteAmountOut", "type": "u64" },
                    { "name": "lpFeeBasisPoints", "type": "u64" },
                    { "name": "lpFee", "type": "u64" },
                    { "name": "protocolFeeBasisPoints", "type": "u64" },
                    { "name": "protocolFee", "type": "u64" },
                    { "name": "quoteAmountOutWithoutLpFee", "type": "u64" },
                    { "name": "userQuoteAmountOut", "type": "u64" },
                    { "name": "pool", "type": "pubkey" },
                    { "name": "user", "type": "pubkey" },
                    { "name": "userBaseTokenAccount", "type": "pubkey" },
                    { "name": "userQuoteTokenAccount", "type": "pubkey" },
